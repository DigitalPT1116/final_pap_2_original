...
-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index_loggedout.php" class="logo" align="left">DIGITAL<em> PT</em>
                        ...
                        <ul class="nav">
                           <!--  <li class="scroll-to-section"><a href="#" class="active">Página Inicial</a></li>-->
                            ...
                            <li class="scroll-to-section"><a href="videos_loggedout.php">Treinos</a></li>
                            <li class="scroll-to-section"><a href="360_loggedout.php">Zona 360</a></li>
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    ...
                    <a href="galeria de videos/treino_outdoor.html"><h4>Treino outdoor</h4></a>
        ...
        <div class="container">
            ...
            <div class="row" >
              ...
              <div class="col-lg-4" >
                  <div class="trainer-item" >
                        <div class="image-thumb" >
                            <img src="assets/images/paulo.jpg" alt="RodrigoRocha"style="width:100%">
                        </div><br><br><br><br>
                        <div class="down-content">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-4 justify-content-end">
      ...
      <li class="nav-item"><a href="parceria.php" class="nav-link px-2 text-muted">Parceiros</a></li>
      <li class="nav-item"><a href="#our-classes" class="nav-link px-2 text-muted">FAQs</a></li>
      <li class="nav-item"><a href="sobre_nos.php" class="nav-link px-2 text-muted">Sobre</a></li>
    </ul>
  </footer>
</div>
    <!-- ***** Footer Ends ***** -->
