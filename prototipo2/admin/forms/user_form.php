<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="text" name="level" value="<?php echo htmlspecialchars($edit ? $utilizador['level'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="level" class="form-control" required="required" id="level">
    </div> 
    <div class="form-group">
