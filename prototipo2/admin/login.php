...
<div id="page-" class="col-md-4 col-md-offset-4">
	<form class="form loginform" method="POST" action="authenticate.php">
		<div class="login-panel panel panel-default">
			<div class="panel-heading">Por favor faz login</div>
			<div class="panel-body">
				...
				<div class="checkbox">
					<label>
						<input name="remember" type="checkbox" value="1">Relembrar
					</label>
				</div>
				...
				<?php endif; ?>
				<button type="submit" value="Entrar" class="btn btn-success loginField">Login</button>
				<button type="submit" formaction="../index.php" class="btn btn-warning loginField">Voltar</button>
			</div>
